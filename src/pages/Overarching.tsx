...
const Overarching = () => {
  return (
    <div className="container mx-auto py-6">
      ...
      <FilterPanel
        title="Overarching Filters"
        items={[...energyFuels, ...scenarios]}
          ...
          drillDownContent={
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <ChartPlaceholder title="Scenario Comparison" />
                <ChartPlaceholder title="Cumulative Emissions" />
                <div className="col-span-2">
                  <ChartPlaceholder title="Carbon Budget Analysis" />
                </div>
              </div>
            </div>
          }
